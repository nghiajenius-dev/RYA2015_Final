...
void LED_Display_init(void)
{
	...
	ROM_SysCtlPeripheralEnable(LED4_PERIPHERAL);
	ROM_SysCtlPeripheralEnable(LED5_PERIPHERAL);
	ROM_SysCtlPeripheralEnable(LED6_PERIPHERAL);
	...
	ROM_GPIOPinTypeGPIOOutput(LED4_PORT, LED4_PIN);
	ROM_GPIOPinTypeGPIOOutput(LED5_PORT, LED5_PIN);
	ROM_GPIOPinTypeGPIOOutput(LED6_PORT, LED6_PIN);
